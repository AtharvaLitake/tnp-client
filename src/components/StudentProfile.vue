      ...
      <div v-if="!loader">
            ...
            <v-row class="d-flex" no-gutters>
              <v-col cols="6">
                <p class="text-body-1 text-primary mb-2">
                  Engineering Branch -
                  <span class="custom-style">{{ studentDetails.branch }}</span>
                </p>
                <p class="text-body-1 font-weight-regular text-primary mb-2">
                  Registration Number -
                  <span class="custom-style">{{
                    studentDetails.pictRegistrationId
                  }}</span>
                </p>
                <p class="text-body-1 font-weight-regular text-primary mb-2">
                  University PRN -
                  <span class="custom-style">{{
                    studentDetails.universityPRN
                  }}</span>
                </p>
              </v-col>
              <v-col cols="6">
                ...
                <p class="text-body-1 font-weight-regular text-primary mb-2">
                  Gender -
                  <span class="custom-style">{{ studentDetails.gender }}</span>
                </p>
              </v-col>
            </v-row>
          </v-col>
        ...
        <v-row class="mb-3" no-gutters>
          ...
          <v-col cols="6">
            <p class="text-body-1 font-weight-regular text-primary mb-2 ml-10">
              PanCard -
              <span class="custom-style">{{ studentDetails.panNumber }}</span>
            </p>
          </v-col>
        </v-row>
        <h1 class="text-h5 font-weight-bold text-primary mb-2">
        ...
        <h1 class="text-h5 font-weight-bold text-primary mb-2">
          Amcat Result Details
        </h1>
        <v-row class="mb-2" no-gutters>
          <v-col cols="6">
            <p class="text-body-1 font-weight-regular text-primary mb-2">
              ELQ Score -
              <span class="custom-style">{{ studentDetails.elqScore }}</span>
            </p>
          </v-col>
          <v-col cols="6">
            <p class="text-body-1 font-weight-regular text-primary mb-2 ml-10">
